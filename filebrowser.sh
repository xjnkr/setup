...
wget https://raw.githubusercontent.com/r1614/setup/main/filebrowser.json > /dev/null 2>&1

echo "downloaded filebrowser.json"

cd /data/filebrowser

wget -O docker-compose.yml https://raw.githubusercontent.com/r1614/setup/main/filebrowser.yml > /dev/null 2>&1
